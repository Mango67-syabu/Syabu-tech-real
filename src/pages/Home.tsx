              ...
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-blue-600 font-medium">
                    Buku Digital Premium
                  </p>
                </div>
              </div>
              <p className="text-gray-600 mb-4">
                Koleksi e-book berkualitas tinggi dalam berbagai topik seperti
                bisnis, teknologi, dan pengembangan diri.
              </p>
              ...
              <div className="flex items-center mb-4">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-purple-600 font-medium">
                    Design Template Siap Pakai
                  </p>
                </div>
              </div>
              <p className="text-gray-600 mb-4">
                Template website, landing page, dan dashboard yang modern dan
                responsive untuk berbagai kebutuhan bisnis.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Semua produk telah melalui kurasi ketat untuk menjamin kualitas
                terbaik
              </p>
            </div>
